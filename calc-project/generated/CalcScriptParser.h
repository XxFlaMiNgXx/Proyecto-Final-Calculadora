...
class  CalcScriptParser : public antlr4::Parser {
public:
  enum {
  ...
  enum {
    RuleProgram = 0, RuleStatement = 1, RuleAssignment = 2, RulePrint = 3, 
    RuleExpr = 4, RuleAtom = 5, RuleFunction = 6
  };

  explicit CalcScriptParser(antlr4::TokenStream *input);

  CalcScriptParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);

  ~CalcScriptParser() override;
